...
public class AppManagedDownload {
            ...
            case DOWNLOADING:
                ...
                if (now - 1000 > last) {
                    ...
                    for (VideoFileInfo dinfo : dinfoList) {
                        ...
                        percentage += dinfo.getCount() / (float) dinfo.getLength();
                    ...
                    percentage = percentage / dinfoList.size();
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            sname = videoinfo.getTitle();
          
            VGet v = new VGet(videoinfo, path, sname);
