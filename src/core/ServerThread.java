...
public class ServerThread extends Thread {
			...
			while(!stop){
				...
				case "givemeinfo":
					...
					if (isPlaying()){
						...
						message = "Aucune musique n'est jou�e ! \n";
					}
					if (listeAtt!=null){
					...
					break;
				default:
					if(receivedData.startsWith("vlalachanson")){ //� compl�ter ^^
	...
	public static void lireNext() {
		...
		if (listeAtt !=null){
			...
			System.out.println("Chanson tir�e au hasard :D");
	...
	public static String whichPlaying(){
		if (isPlaying()){
			...
			return("Aucune musique n'est jou�e !");
		}
	}
